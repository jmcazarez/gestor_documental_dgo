...
export class TableroDeInventarioFisicoComponent implements OnInit {
    ...
    obtenerPrestamosDeDocumentos(): void {
        ...
        this.inventarioFisicoService.obtenerInventario().subscribe((resp: any) => {
    ...
    eliminarPrestamo(row): void {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                // realizamos delete
                this.inventarioFisicoService.eliminarInventario(row).subscribe((resp: any) => {
                    Swal.fire('Eliminado', 'El prestamo de documentos ha sido eliminado.', 'success');
                    this.obtenerPrestamosDeDocumentos();
                    this.limpiar();
                }, err => {
                    this.cargando = false;
