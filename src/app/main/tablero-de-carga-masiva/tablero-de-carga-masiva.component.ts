...
export class TableroDeCargaMasivaComponent implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
        ...
        this.firstFormGroup.get('historial').valueChanges.subscribe(val => {
            ...
            if (val) {
                tempHistorial = this.arrHistorialCarga.filter((d) => d.id.toLowerCase().indexOf(val.toLowerCase()) !== -1 || !val);
                        ...
                        tempHistorial[0].historial_carga_detalles.forEach(element => {
                            if (element.documento && element.bCargado === false) {
                                this.documentos.push({
                                    ...
                                    cNombreDocumento: element.documento.name,
    ...
    obtenerDocumentos(): void {
        ...
        let filtroReporte = '';
        let temp = [];
        const fechaIniCreacion = this.datePipe.transform(this.fechaCreacion, 'yyyy-MM-dd') + 'T00:00:00.000Z';
        const fechaFinCreacion = this.datePipe.transform(this.fechaCreacion, 'yyyy-MM-dd') + 'T24:00:00.000Z';
        const fechaIniCarga = this.datePipe.transform(this.fechaCarga, 'yyyy-MM-dd') + 'T00:00:00.000Z';
        const fechaFinCarga = this.datePipe.transform(this.fechaCarga, 'yyyy-MM-dd') + 'T24:00:00.000Z';
        const fechaIniModificacion = this.datePipe.transform(this.fechaModificacion, 'yyyy-MM-dd') + 'T00:00:00.000Z';
        const fechaFinModificacion = this.datePipe.transform(this.fechaModificacion, 'yyyy-MM-dd') + 'T24:00:00.000Z';
        ...
        if (this.selectedInformacion !== undefined && this.selectedInformacion !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'visibilidade.cDescripcionVisibilidad=' + this.selectedInformacion;
            } else {
                filtroReporte = filtroReporte + '&visibilidade.cDescripcionVisibilidad=' + this.selectedInformacion;
            }
        }

        if (this.documentoBusqueda !== undefined && this.documentoBusqueda !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'cNombreDocumento=' + this.documentoBusqueda;
            } else {
                filtroReporte = filtroReporte + '&cNombreDocumento=' + this.documentoBusqueda;
            }
        }

        if (this.fechaCreacion !== undefined && this.fechaCreacion !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'fechaCreacion_gte=' + fechaIniCreacion + '&fechaCreacion_lte=' + fechaFinCreacion;
            } else {
                filtroReporte = filtroReporte + '&fechaCreacion_gte=' + fechaIniCreacion + '&fechaCreacion_lte=' + fechaFinCreacion;
            }
        ...
        if (this.fechaCarga !== undefined && this.fechaCarga !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'fechaCarga_gte=' + fechaIniCarga + '&fechaCarga_lte=' + fechaFinCarga;
            } else {
                filtroReporte = filtroReporte + '&fechaCarga_gte=' + fechaIniCarga + '&fechaCarga_lte=' + fechaIniCarga;
            }

        }


        if (this.fechaModificacion !== undefined && this.fechaModificacion !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'updatedAt_gte=' + fechaIniModificacion + '&updatedAt_lte=' + fechaFinModificacion;
            } else {
                filtroReporte = filtroReporte + '&updatedAt_gte=' + fechaIniModificacion + '&updatedAt_lte=' + fechaFinModificacion;
            }
        ...
        if (this.selectTipoDocumento !== undefined && this.selectTipoDocumento !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'tipo_de_documento.id=' + this.selectTipoDocumento;
            } else {
        ...
        */
        if (this.selectedExpediente !== undefined && this.selectedExpediente !== '') {
            if (filtroReporte === '') {
                ...
                filtroReporte = filtroReporte + '&tipo_de_expediente.id=' + this.selectedExpediente;
            }
        }

        if (this.selectedFolioExpediente !== undefined && this.selectedFolioExpediente !== '') {
            if (filtroReporte === '') {
                filtroReporte = 'folioExpediente=' + this.selectedFolioExpediente;
            } else {
                filtroReporte = filtroReporte + '&folioExpediente=' + this.selectedFolioExpediente;
            }
        }
        this.documentoService.obtenerDocumentoReporte(filtroReporte).subscribe((resp: any) => {
            ...
            if (this.optConsultar) {
                        ...
                        if (encontro) {
                            if (documento.tipo_de_documento.bActivo && encontro.Consultar && info) {
                                ...
                                if (documento.tipo_de_expediente) {
                                    ...
                                    cDescripcionTipoExpediente = documento.tipo_de_expediente.cDescripcionTipoExpediente;
                                }
                ...
                if (this.selectTipoDocumento !== '' && this.selectTipoDocumento !== undefined && this.selectTipoDocumento !== null) {
                    ...
                    temp = documentosTemp.filter((d) => d.tipo_de_documento.toLowerCase().indexOf(this.selectTipoDocumento.toLowerCase()) !== -1 || !this.selectTipoDocumento);
    ...
    descargarDocumentos(): void {
        ...
        this.documentos.forEach(element => {
            ...
            if (element.selected && String(element.idDocumento).length > 0) {
                this.documentoService.dowloadDocument(element.idDocumento, element.id, this.menuService.usuario, element.cNombreDocumento).subscribe((resp: any) => {
                    ...
                    Swal.fire(
                        'Error',
                        'Ocurrió un error al descargar documento.' + err.error,
                        'error'
                    );
                });
            } else {
    ...
    async obtenerHistorialCarga(): Promise<void> {
        ...
        this.historialCarga.obtenerHistorialCarga(this.usuario[0].data.id).subscribe((resp: any) => {
            ...
            Swal.fire(
                'Error',
                'Ocurrió un error al  obtener el historial de cargas.' + err.error,
                'error'
            );
        });
    }
    ...
    add(): void {
        ...
        fileInput.onchange = async () => {
            ...
            if (this.selectedHistorial === '') {
                this.historialCarga.guardarHistorial({ cUsuario: this.menuService.usuario }).subscribe((resp: any) => {
                    ...
                    Swal.fire(
                        'Error',
                        'Ocurrió un error al guardar el historial de cargas.' + err.error.error,
                        'error'
                    );
                });
            }
            ...
            for (let index = 0; index < fileInput.files.length; index++) {
                ...
                if (this.base64.data) {
                    const resultado = await this.uploadService.subirArchivo(file, this.base64.data);
                    ...
                    if (resultado.error) {
                        ...
                        const hCarga = await this.historialCarga.guardarHistorialDetalle({ documento: resultado.data[0].id, historial_carga_encabezados: [this.selectedHistorial] })
                        if (hCarga.error) {
                            this.spinner.hide();
                            Swal.fire(
                                'Error',
                    ...
                    reader.onloadend = () => {
                        ...
                        base64Result = base64Result.slice(base64Result.search('/Count'), base64Result.search('/Count') + 10).replace('/Count ', '');
    ...
    descargarFormatoExcel(): void {
        this.exportExcel.exportAsExcelFile(this.documentosTemporal, 'formatoDeCarga');
    }
        ...
        reader.onload = (event) => {
            ...
            jsonData['Hoja1'].forEach((row) => {
                ...
                if (row.Documento) {
                    ...
                    const x = this.documentos.findIndex((doc) => doc.documento === row.Documento);
                    try {
                        if (x >= 0) {

                            this.documentos[x].valido = false;
                            if (row['Nombre del documento'] && row['Nombre del documento'].length > 0) {
                                this.documentos[x].cNombreDocumento = row['Nombre del documento'];
                            } else {
                                this.documentos[x].valido = false;
                                if (textError.length > 0) {
                                    textError = 'El nombre del documento es obligatorio';
                                } else {
                                    textError = textError + ', el nombre del documento es obligatorio';
                                }
                            }
                            ...
                            if (new Date(row['Fecha de creación'])) {
                                ...
                                this.documentos[x].valido = false;
                                if (textError.length > 0) {
                                    textError = 'La fecha de creación obligatorio';
                                } else {
                                    textError = textError + ', la fecha de creación obligatorio';
                                }
                            }
                            ...
                            if (row['Tipo de expediente'] && row['Tipo de expediente'].length > 0) {
                                const encontro = this.arrExpediente.find((tipo: { cDescripcionTipoExpediente: string; }) =>
                                    tipo.cDescripcionTipoExpediente === row['Tipo de expediente']);


                                if (encontro) {
                                    this.documentos[x].tipo_de_expediente = encontro.id;
                                    this.documentos[x].expediente = encontro.cDescripcionTipoExpediente;
                                    this.documentos[x].idExpediente = encontro.id;
                                } else {
                                    this.documentos[x].valido = false;
                                    if (textError.length > 0) {
                                        textError = 'El tipo de expediente es obligatorio';
                                    } else {
                                        textError = textError + ', el tipo de expediente es obligatorio';
                                    }
                                }
                            } else {
                                this.documentos[x].valido = false;
                            ...
                            if (String(row['Folio de expediente']).length > 0) {
                                this.documentos[x].folioExpediente = String(row['Folio de expediente']);
                            } else {
                            ...
                            if (this.arrMetacatalogos.length > 0) {
                                ...
                                while (num <= 5) {
                                    ...
                                    if (this.arrMetacatalogos[num]) {
                                        if (this.arrMetacatalogos[num].bOligatorio) {
                                            ...
                                            if (String(row['Meta_' + metaRow]).length > 0) {
                                                if (this.arrMetacatalogos[num].cTipoMetacatalogo === 'Fecha') {
                                                    if (new Date(row['Meta_' + metaRow])) {
                                                        ...
                                                        this.documentos[x].valido = false;
                                                        if (textError.length > 0) {
                                                            textError = 'El ' + 'Meta_' + metaRow + ' es incorrecto';
                                                        } else {
                                                            textError = textError + ', el ' + 'Meta_' + metaRow + ' es incorrecto';
                                                        }
                                                    }
                                                } else if (this.arrMetacatalogos[num].cTipoMetacatalogo === 'Sí o no' || this.arrMetacatalogos[num].cTipoMetacatalogo === 'Texto') {
                                                    if (String(row['Meta_' + metaRow])) {
                                                        this.arrMetacatalogos[num].text = String(row['Meta_' + metaRow]);
                                                    } else {
                                                        this.documentos[x].valido = false;
                                                        if (textError.length > 0) {
                                                            textError = 'El ' + 'Meta_' + metaRow + ' es incorrecto';
                                                ...
                                                else if (this.arrMetacatalogos[num].cTipoMetacatalogo === 'Numérico') {
                                                    if (Number(row['Meta_' + metaRow])) {
                                                        this.arrMetacatalogos[num].text = Number(row['Meta_' + metaRow]);
                                                    } else {
                                                        this.documentos[x].valido = false;
                                                        if (textError.length > 0) {
                                                            textError = 'El ' + 'Meta_' + metaRow + ' es incorrecto';
                                                ...
                                                this.arrMetacatalogos[num].text = 'El metacatalago ' + 'Meta_' + metaRow + '  es obligatorio';
                                                if (textError.length > 0) {
                                                    textError = 'El metacatalago ' + 'Meta_' + metaRow + '  es obligatorio';
                                                } else {
                                                    textError = textError + ', el metacatalago ' + 'Meta_' + metaRow + '  es obligatorio';
                                                    this.documentos[x].valido = false;
                                                }
                                            }
                                        } else {
                                    ...
                                    this.arrMetacatalogos = [...this.arrMetacatalogos];
                                    this.documentos[x].metacatalogos = this.arrMetacatalogos;
                                    this.documentos = [...this.documentos];
                                }
                                if (this.documentos[x].metacatalogos) {
                                    let meta = '';
                                    if (this.documentos[x].metacatalogos) {
                                        for (const i of this.documentos[x].metacatalogos) {
        ...
        this.documentos.forEach((row) => {
            ...
            if (row.valido) {
                ...
                this.documentoService.guardarDocumento(row).subscribe((resp: any) => {
                    ...
                    if (resp) {
                        const x = this.documentos.findIndex((std: { documento: string; }) => std.documento === row.documento);
                        // Obtenemos el historial de carga
                        this.historialCarga.actualizarDetalle({ bCargado: true }, row.idDetalle).subscribe((resp: any) => {

                        }, err => {
                            this.spinner.hide();
                            Swal.fire(
                                'Error',
                                'Ocurrió un error al guardar el historial de cargas detalle.' + err.error,
                                'error'
                            );
                        });
                        ...
                        if (this.documentos.length === 0) {
                            this.historialCarga.actualizarHistorial({ bCompletado: true }, row.idEncabezado).subscribe((resp: any) => {
                                Swal.fire('Éxito', 'Documentos guardados. ', 'success');
                                this.selectedHistorial = '';
                                this.obtenerHistorialCarga();
                            }, err => {
                                this.spinner.hide();
    ...
    async eliminarHistorialCarga(): Promise<void> {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                // realizamos delete
                this.historialCarga.actualizarHistorial({ bActivo: false }, this.selectedHistorial).subscribe((resp: any) => {
                    this.selectedHistorial = '';
                    this.obtenerHistorialCarga();
                    this.spinner.hide();
                }, err => {
                    ...
                    Swal.fire(
                        'Error',
                        'Ocurrió un error al eliminar el historial de carga.' + err.error,
                        'error'
                    );
                });
