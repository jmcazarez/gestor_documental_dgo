                        ...
                        if (ini.participantes) {
                            ...
                            for (const participante of objPartificapntes) {
                                ...
                                if (nombresParticipantes === '') {
                                    nombresParticipantes =   participante.nombre + ' ' + participante.apellidoPaterno + ' ' + participante.apellidoMaterno;
                                } else {
                                    nombresParticipantes = nombresParticipantes + ' , ' +  participante.nombre + ' ' + participante.apellidoPaterno + ' ' + participante.apellidoMaterno;
                                }
                            }
                        }
