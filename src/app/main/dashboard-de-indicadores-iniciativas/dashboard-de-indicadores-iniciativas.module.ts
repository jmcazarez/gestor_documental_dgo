...
const routes = [
    {
        path: 'dashboard-de-indicadores-iniciativas',
        component: DashboardDeIndicadoresIniciativasComponent,
...
@NgModule({
    declarations: [
        DashboardDeIndicadoresIniciativasComponent
    ],
    imports: [
...
export class DashboardDeIndicadoresIniciativasModule {
}