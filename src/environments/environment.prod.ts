export const environment = {
    ...
    apiCms: 'http://138.185.2.214:64081/',

    apiStrapi: 'http://138.185.2.214:64082/',
    apiStrapiMin: 'http://138.185.2.214:64082',
    imageBase64: '',
    widgets: {
        widget1: {
            chartType: 'line',
        ...
        widget5: {
            ...
            datasets: {
                'yesterday': [
                    ...
                    {
                        label: 'Documentos',
                        data: [2200, 2900, 3900, 2500, 3800, 3200, 2900, 1900, 3000, 3400, 4100, 3800, 2200, 2900, 3900, 2500, 3800, 3200, 2900, 1900, 3000, 3400, 4100, 3800],
                        fill: 'start'
                    }
                ],
                'today': [
                    ...
                    {
                        label: 'Documentos',
                        data: [3000, 3400, 4100, 3800, 2200, 3200, 2900, 1900, 2900, 3900, 2500, 3800, 2200, 2900, 3900, 2500, 3800, 3200, 2900, 1900, 3000, 3400, 4100, 3800],
                        fill: 'start'
