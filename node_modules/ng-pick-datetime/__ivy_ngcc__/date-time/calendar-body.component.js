...
function OwlCalendarBodyComponent_tr_0_td_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function OwlCalendarBodyComponent_tr_0_td_1_Template_td_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r108); var item_r105 = ctx.$implicit; var ctx_r107 = ɵngcc0.ɵɵnextContext(2); return ctx_r107.selectCell(item_r105); });
    ...
    var colIndex_r106 = ctx.index;
    var rowIndex_r103 = ɵngcc0.ɵɵnextContext().index;
    var ctx_r104 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("owl-dt-calendar-cell ", item_r105.cellClass, "");
    ɵngcc0.ɵɵstyleProp("width", 100 / ctx_r104.numCols, "%")("padding-top", 50 * ctx_r104.cellRatio / ctx_r104.numCols, "%")("padding-bottom", 50 * ctx_r104.cellRatio / ctx_r104.numCols, "%");
    ɵngcc0.ɵɵclassProp("owl-dt-calendar-cell-active", ctx_r104.isActiveCell(rowIndex_r103, colIndex_r106))("owl-dt-calendar-cell-disabled", !item_r105.enabled)("owl-dt-calendar-cell-in-range", ctx_r104.isInRange(item_r105.value))("owl-dt-calendar-cell-range-from", ctx_r104.isRangeFrom(item_r105.value))("owl-dt-calendar-cell-range-to", ctx_r104.isRangeTo(item_r105.value));
    ɵngcc0.ɵɵproperty("tabindex", ctx_r104.isActiveCell(rowIndex_r103, colIndex_r106) ? 0 : 0 - 1);
    ɵngcc0.ɵɵattribute("aria-label", item_r105.ariaLabel)("aria-disabled", !item_r105.enabled || null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction3(24, _c1, item_r105.out, item_r105.value === ctx_r104.todayValue, ctx_r104.isSelected(item_r105.value)));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(item_r105.displayValue);
} }
function OwlCalendarBodyComponent_tr_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", row_r102);
} }
